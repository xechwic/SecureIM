...
public class ChatKeyboardLayout extends SoftHandleLayout implements EmoticonsToolBarView.OnToolBarItemClickListener {
    ...
    private void initView(Context context) {
        ...
        EmoticonHandler.getInstance(context.getApplicationContext()).loadEmoticonsToMemory();
    ...
    public void clearInputAreaListener(){
        etInputArea.setOnKeyListener(null);
        etInputArea.setOnTouchListener(null);
        etInputArea.setOnFocusChangeListener(null);
        etInputArea.setOnTextChangedInterface(null);
        etInputArea.clearAnimation();
        etInputArea.clearComposingText();
        etInputArea.removeTextChangedListener(null);
        etInputArea.removeCallbacks(null);
        etInputArea.setEnabled(false);
    }
    public void del(){
    ...
    public static void initEmoticonsDB(final Context context, final boolean isShowEmoji, final List<EmoticonEntity> emoticonEntities,final String[] emojiData) {
...
//                    ArrayList<EmoticonBean> emojiArray = Utils.ParseData(DefEmoticons.emojiArray, EmoticonBean.FACE_TYPE_NORMAL, EmoticonBase.Scheme.DRAWABLE);
                    ArrayList<EmoticonBean> emojiArray = Utils.ParseData(emojiData,
